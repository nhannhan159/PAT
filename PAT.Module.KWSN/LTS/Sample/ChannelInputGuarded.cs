...
namespace PAT.KWSN.LTS{
    public sealed class ChannelInputGuarded : Process
    {
        ...
        public ChannelInputGuarded(string evtName, Expression[] exp, Process process, Expression guard)
        {
            ChannelName = evtName;            
            ExpressionList = exp;
            Process = process;
        ...
        {
            return ChannelName + "?[" + GuardExpression.ToString() + "]" + Common.Classes.Ultility.Ultility.PPStringListDot(ExpressionList).TrimStart('.') + "->" + Process;
        }
        ...
        public override Process ClearConstant(Dictionary<string, Expression> constMapping)
        {
            ...
            return new ChannelInputGuarded(ChannelName, newExpression, Process.ClearConstant(constMapping), GuardExpression.ClearConstant(constMapping));
        }
