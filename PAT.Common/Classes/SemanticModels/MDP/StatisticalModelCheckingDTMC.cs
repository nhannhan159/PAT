...
{
    public class SingleSamplingPlanNoMDP
    {
        public long minSmpSize;
        public long minTruthSize;

        public SingleSamplingPlanNoMDP(long X, long Y)
        {
            minSmpSize = X;
            minTruthSize = Y;
        }
    ...
    public class SimulationNoMDP
    {
        ...
        public double boundedStep=1000;
        public double currentStep = 0;
        public MDPConfiguration intialConfiguration;
        public Expression ReachableStateCondition;
        public long numberOfTotalVisitedStates=0;
        // public Expression ReachableStateCondition;
        ...
        //public SimulationNoMDP(MDPStat mdpl)
        //{
        //    mdp = mdpl;
        //    random = new Random();
        //}

        //public SimulationNoMDP(long Y)
        //{
        //    trials = Y;
        //    status = true;
        //    random = new Random();
        ...
        //public SimulationNoMDP(long Y, Random random)
        //{
        //    trials = Y;
        //    status = true;
        //    this.random = random;
        ...
        /*getsingleTrail:  old version, used after builtMDP*/
...
//        }
        ...
        public MDPStateStat sampleNextState(DistributionStat action)
        {
            ...
            foreach (KeyValuePair<double, MDPStateStat> pair in action.States)
                //assume every state has distribution(s) with at least one pair
            {
    ...
    public class RunTestNoModel
    {
        public SingleSamplingPlanNoMDP ssp;
        ...
        public void SetSSP(SingleSamplingPlanNoMDP sspll)
        {
            ssp = sspll;
        }
        ...
        //Verify DTMC: SPRT
        public bool verifyDTMC(SimulationNoMDP sml, out string report)
        {
            report = "";
            reSetRunTest();
            bool result = sequentialProbRatioTest(sml);
