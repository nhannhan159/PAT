...
namespace PAT.Common.Classes.BA.Algorithms.comparator
{
    ...
    public class PairedStringSortedSetComparator : System.Collections.Generic.IComparer<Pair<string, BASortedSet<FAState>>>
    {
        public int Compare(Pair<String, BASortedSet<FAState>> s1, Pair<String, BASortedSet<FAState>> s2)
        {
            ...
            {
                return s1.Left.CompareTo(s2.Left) > 0 ? 1 : -1;
            }
        }
