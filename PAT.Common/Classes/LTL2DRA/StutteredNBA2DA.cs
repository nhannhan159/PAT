 ...
 */
        ...
        public class TreeWithAcceptance
        {


            /** The tree */
            public StateInterface _tree;

            /** The acceptance signature */
            public RabinSignature _signature;
             ...
             * @return the Tree.
             */
            public StateInterface getTree() { return _tree; }

            /** Get the AcceptanceSignature. 
             * @return the AcceptanceSignature */
            public  RabinSignature getSignature() { return _signature; }
            ...
            public static bool operator <(TreeWithAcceptance one, TreeWithAcceptance other)
            {
                if (one._tree < other.getTree())
                {
                    return true;
                }
                if (one._tree == other.getTree())
                {
                    return one._signature < other.getSignature();
                }
                return false;
            }
...
public class StutteredNBA2DA
{
     ...
     */
    public class StutteredConvertor
    {
