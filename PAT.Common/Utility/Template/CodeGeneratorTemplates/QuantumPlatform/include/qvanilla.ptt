...
#if (QF_MAX_ACTIVE <= 8)
    extern "C" QPSet8  volatile QF_readySet_; ///< ready set of active objects
#else
    extern "C" QPSet64 volatile QF_readySet_; ///< ready set of active objects
#endif
...
extern "C" uint8_t volatile QF_currPrio_; ///< current task/interrupt priority
extern "C" uint8_t volatile QF_intNest_;          ///< interrupt nesting level
