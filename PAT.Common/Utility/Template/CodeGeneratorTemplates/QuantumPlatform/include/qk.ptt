...
#define QF_EQUEUE_TYPE             QEQueue
    ...
    extern "C" QP::QPSet8  volatile QK_readySet_;         ///< ready set of QK
#else
    extern "C" QPSet8  volatile QK_readySet_;             ///< ready set of QK
#endif
#else
#ifdef Q_USE_NAMESPACE
    extern "C" QP::QPSet64 volatile QK_readySet_;         ///< ready set of QK
#else
    extern "C" QPSet64 volatile QK_readySet_;             ///< ready set of QK
#endif
#endif

extern "C" uint8_t volatile QK_currPrio_; ///< current task/interrupt priority
extern "C" uint8_t volatile QK_intNest_;          ///< interrupt nesting level
