...
namespace PAT.Common.GUI.Drawing
{
    ...
    public abstract class CanvasItem : BaseRectangle, IInteractiveDrawable, IDrawableRectangle, IInteractiveRectangle
    {
        ...
        public ItemState CurrentState = ItemState.Free;
        ...
        /// <summary>
        /// In case do not need to update position from PositionChanging (this, e);
        /// </summary>
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly")]
        public void MoveFast(float x, float y)
        {
            base.X = x;
            base.Y = y;
        ...
        public virtual XmlElement WriteToXml(XmlDocument document)
        {
        ...
        public virtual void LoadFromXml(XmlElement XMLelement)
        {
            try
            {
